...
namespace Core.Application.UnitTests.Listings.Commands.DeactivateSuspiciousListing
{
    public class DeactivateSuspiciousListingModelValidator_should
    {
        private readonly DeactivateSuspiciousListingModelValidator _sut;
        public DeactivateSuspiciousListingModelValidator_should()
        {
            _sut = new DeactivateSuspiciousListingModelValidator();
        }

        [Fact]
        public void have_validation_error_if_ListingId_is_not_valid()
        {
            var model = new DeactivateSuspiciousListingModel()
            {
