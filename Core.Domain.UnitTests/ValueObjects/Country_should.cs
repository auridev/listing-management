...
namespace Core.Domain.UnitTests.ValueObjects
{
    public class Country_should
    {
        ...
        {
            Action createAction = () => Country.Create(name, Alpha2Code.Create(alpha2).ToUnsafeRight(), Alpha3Code.Create(alpha3).ToUnsafeRight(), currency);
        ...
        {
            var country = Country.Create("  united states  ", Alpha2Code.Create("us").ToUnsafeRight(), Alpha3Code.Create("stt").ToUnsafeRight(), Currency.Euro);
        ...
        {
            var country = Country.Create("united kingdom", Alpha2Code.Create("as").ToUnsafeRight(), Alpha3Code.Create("fgg").ToUnsafeRight(), Currency.Euro);
        ...
        {
            var first = Country.Create("c1country", Alpha2Code.Create("c2").ToUnsafeRight(), Alpha3Code.Create("c33").ToUnsafeRight(), Currency.Euro);
            var second = Country.Create("c1country", Alpha2Code.Create("c2").ToUnsafeRight(), Alpha3Code.Create("c33").ToUnsafeRight(), Currency.Euro);
        ...
        {
            var first = Country.Create("LT", Alpha2Code.Create("AA").ToUnsafeRight(), Alpha3Code.Create("bbb").ToUnsafeRight(), Currency.Euro);
            var second = Country.Create("LT", Alpha2Code.Create("AA").ToUnsafeRight(), Alpha3Code.Create("bbb").ToUnsafeRight(), Currency.Euro);
        ...
        {
            var first = Country.Create(firstName, Alpha2Code.Create(firstAlpha2Code).ToUnsafeRight(), Alpha3Code.Create(firstAlpha3Code).ToUnsafeRight(), Currency.Euro);
            var second = Country.Create(secondName, Alpha2Code.Create(secondAlpha2Code).ToUnsafeRight(), Alpha3Code.Create(secondAlpha3Code).ToUnsafeRight(), Currency.Euro);
